...
If you need to examine the source code to OpenCode to help you determine how to perform your edits, you may find its source code through the symbolic link located at ./opencode-source. 
